...
export default function Home() {
  return (
    <Stack
      direction="column"
      gap={1}
      sx={{ height: "100%", minHeight: "90vh", paddingY: "20px", alignItems: "flex-start", paddingX:"20px" }}
    >
      <Box sx={{ marginLeft: "auto", marginRight: "auto", marginBottom:"30px", marginTop:"10px" }}>
        <Image
          src="/logo.png"
          alt="logo"
          width={125}
      ...
      <Button startIcon={<LogoutIcon />} sx={{ marginTop: "auto" }}>Logout</Button>
    </Stack>
  );
}
